...
const listarEstados = () => __awaiter(void 0, void 0, void 0, function* () {
    // Busca todos os estados únicos usando Mongoose + MongoDB
    const estados = yield joblocation_schema_1.default.distinct("estado");
    // Ordena alfabeticamente
    estados.sort();
    let response = null;
    if (estados.length >= 1) {
        response = yield HttpResponse.ok(estados);
    }
    else {
