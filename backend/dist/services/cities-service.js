...
const listarCidade = (state) => __awaiter(void 0, void 0, void 0, function* () {
    // Busca todos os estados únicos usando Mongoose + MongoDB
    const cities = yield joblocation_schema_1.default
        .find({ estado: state })
        .select("cidade -_id")
        .lean()
    ...
    let response = null;
    if (cities.length >= 1) {
        response = yield HttpResponse.ok(cities);
    }
    else {
...
exports.listarCidade = listarCidade;
